...
body{
	   background: url(digital.jpg) no-repeat center center fixed;
...
<div class="forgot">
        <form name="frm" method="post" action="ChangePassword1.jsp">
			...
			%>
  			...
  			<br>
    		<input type="text" name="oldpass" placeholder="	Existing Password" required>
